...
HD_PWD='/home/appletea/workspace_onedevice_2/SoC/project_1_FND/project_1_FND.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_FND_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_FND_wrapper.tcl
