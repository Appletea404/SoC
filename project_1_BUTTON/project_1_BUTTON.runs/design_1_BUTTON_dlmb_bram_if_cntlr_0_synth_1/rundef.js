...
ISEStep( "vivado",
         "-log design_1_BUTTON_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_BUTTON_dlmb_bram_if_cntlr_0.tcl" );
