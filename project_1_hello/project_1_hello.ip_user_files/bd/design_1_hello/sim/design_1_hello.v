...
//Date        : Fri Apr  3 01:25:48 2026
//Host        : Appletea running 64-bit Ubuntu 24.04.4 LTS
//Command     : generate_target design_1_hello.bd
//Design      : design_1_hello
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "design_1_hello,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1_hello,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=12,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_board_cnt=2,da_clkrst_cnt=1,da_microblaze_riscv_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1_hello.hwdef" *) 
module design_1_hello
   (reset,
    sys_clock,
    usb_uart_rxd,
    usb_uart_txd);
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.RESET RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.RESET, INSERT_VIP 0, POLARITY ACTIVE_HIGH" *) input reset;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN design_1_hello_sys_clock, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input sys_clock;
  ...
  design_1_hello_axi_smc_0 axi_smc
  ...
  design_1_hello_axi_uartlite_0_0 axi_uartlite_0
       (.rx(usb_uart_rxd),
        ...
        .tx(usb_uart_txd));
  design_1_hello_clk_wiz_0 clk_wiz
       (.clk_in1(sys_clock),
        .clk_out1(microblaze_riscv_0_Clk),
        .reset(reset));
  design_1_hello_mdm_1_0 mdm_1
  ...
  (* BMM_INFO_PROCESSOR = "riscv > design_1_hello microblaze_riscv_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  design_1_hello_microblaze_riscv_0_0 microblaze_riscv_0
  ...
  microblaze_riscv_0_local_memory_imp_1A15QLY microblaze_riscv_0_local_memory
  ...
  design_1_hello_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
...
module microblaze_riscv_0_local_memory_imp_1A15QLY
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > design_1_hello microblaze_riscv_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  design_1_hello_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  design_1_hello_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_riscv_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_riscv_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_riscv_0_dlmb_bus_BE),
        .LMB_CE(DLMB_ce),
        ...
        .Sl_UE(microblaze_riscv_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_riscv_0_dlmb_bus_WAIT));
  design_1_hello_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
  ...
  design_1_hello_ilmb_v10_0 ilmb_v10
       (.LMB_ABus(microblaze_riscv_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_riscv_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_riscv_0_ilmb_bus_BE),
        .LMB_CE(ILMB_ce),
        ...
        .Sl_UE(microblaze_riscv_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_riscv_0_ilmb_bus_WAIT));
  design_1_hello_lmb_bram_0 lmb_bram
