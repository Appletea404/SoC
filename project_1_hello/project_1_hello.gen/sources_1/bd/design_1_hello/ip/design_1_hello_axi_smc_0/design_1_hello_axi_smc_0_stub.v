...
// Command     : write_verilog -force -mode synth_stub -rename_top design_1_hello_axi_smc_0 -prefix
//               design_1_hello_axi_smc_0_ design_1_hello_axi_smc_0_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_hello_axi_smc_0,bd_7ddc,{}" *) (* CORE_GENERATION_INFO = "design_1_hello_axi_smc_0,bd_7ddc,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=25,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_7ddc,Vivado 2024.2" *) 
module design_1_hello_axi_smc_0(aclk, aresetn, S00_AXI_awaddr, S00_AXI_awprot, 
